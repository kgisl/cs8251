...
* [UNIT V FILE PROCESSING](#unit-v-file-processing)  
		* [Online References attribution](#online-references-attribution)  
		* [Pre-Unit exercise - a "Show and Tell" exercise](#pre-unit-exercise---a-show-and-tell-exercise)  
		* [Post-Unit exercise](#post-unit-exercise)  
	* [Key Terms](#key-terms)  
	* [File Handling in C Language - Quick Reference](#file-handling-in-c-language---quick-reference)  
* [include <stdio.h>](#include-stdioh)  
* [include <conio.h>](#include-conioh)  
* [include<stdio.h>](#includestdioh)  
* [include<conio.h>](#includeconioh)  
	* [Files](#files)  
...
* [include <stdio.h>](#include-stdioh)  
		* [Modular Versions](#modular-versions)  
			...
			* [modular main()](#modular-main)  
		* [Averaging entries from stdin](#averaging-entries-from-stdin)  
